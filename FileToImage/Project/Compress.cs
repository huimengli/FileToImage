...
namespace FileToImage.Project
{
    ...
    */
    ...
    /// 加密模块追加
    /// </summary>
    public static class CompressAdd
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public static CompressMode Pause(this CompressMode mode,string value)
        {
            switch (value)
            {
                case "无":
        ...
        public static string GetValue(this CompressMode mode)
        {
            switch (mode)
            {
